...
std::vector<typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::Clustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
{
    ...
    clusters = euclideanCluster(points, cloud, tree, clusterTolerance);
    //From PCL
...
template<typename PointT>
std::vector<typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::euclideanCluster(const std::vector<std::vector<float>>& points, typename pcl::PointCloud<PointT>::Ptr cloud, KdTree* tree, float clusterTolerance)
{
    ...
    while( i < points.size())
    {
        ...
        clusterHelper(i, points, cluster, processed, tree, clusterTolerance); //proximity
    ...
    for(std::vector<int> it : clusters_v)
    {
        ...
        cluster_point->width = cluster_point->clusters_v.size();
